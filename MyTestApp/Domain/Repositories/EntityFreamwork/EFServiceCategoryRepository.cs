...
namespace MyTestApp.Domain.Repositories.EntityFreamwork
{
    public class EFServiceCategoryRepository : IServiceCategoriesRepository
    {
        private readonly AppDbContext _context;

        public EFServiceCategoryRepository(AppDbContext context)
        {
            _context = context;
        }
